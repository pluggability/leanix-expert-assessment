...
**Project-specific additions:** Add any project-specific rules below this line (auth provider specifics, PII fields that must stay encrypted, regulated data flows, etc.).
